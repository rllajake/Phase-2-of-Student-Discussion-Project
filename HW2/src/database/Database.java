 ...
 */
	private void createTables() throws SQLException {
		...
		// Deadline attribute added to each invitation code generated
	 ...
	 // Create the one time pass table
 ...
 */
	public void register(User user) throws SQLException {
		...
		try (PreparedStatement pstmt = connection.prepareStatement(insertUser)) {
			...
			currentReviewerRole = user.getReviewerRole();
			pstmt.setBoolean(10, currentReviewerRole);
 ...
 */
	...
	// Deadline is added to the query, use of LocalDateTime and Timestamp classes is needed
	 ...
	 * 
	 */
	// Checks invitation code deeming if it is still available for use or not.
	...
	/*******
	 * <p> Method: String generateOneTimePass(String emailAddress) </p>
	 * 
	 * <p> Description: Given an email address, this method establishes a one time pass
	 *  and adds a record to the OneTimePass table.  When the code is used, the
	 *  it will not be available for use again since it is nullified</p>
	 * 
	 * @param emailAddress specifies the email address for this new user.
	 * 
	 * 
	 * @return the code of six characters so the new user can use it as a one time pass code.
	 * 
	 */
	public String generateOneTimePass(String emailAddress) {
		String code = UUID.randomUUID().toString().substring(0, 6);
		String query = "INSERT INTO OneTimePass (emailAddress, password, used) VALUES (?, ?, ?)";
	...
	/*******
	 * <p> Method: void updatePassword(String password, String emailAddress) </p>
	 * 
	 * <p> Description: Given an email address and new password, this method will replace the 
	 * column with the corresponding email address with a new valid password. </p>
	 * 
	 * @param password specifies the password to update what is in the database
	 * 
	 * @param emailAddress specifies the email address for this new user.
	 * 
	 */
	...
	/*******
	 * <p> Method: void updatePassword2(String password, String username) </p>
	 * 
