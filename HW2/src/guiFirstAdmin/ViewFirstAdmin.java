...
public class ViewFirstAdmin {
	...
	private static Label label_ApplicationTitle = new Label("Student Discussion System Start Page");
	...
	public static void displayFirstAdmin(Stage ps) {
		...
		// state of the system.
		applicationMain.HW2Main.activeHomePage = theRole;	// 1: Admin; 2: Role1; 3 Roles2
