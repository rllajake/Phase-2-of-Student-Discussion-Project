...
public class ViewAdminHome {
	...
	*/
	...
	private static final int theRole = 1;		// Admin: 1; Student: 2; Reviewer: 3
	...
	*/
	...
	public static void displayAdminHome(Stage ps, User user) {
		...
		applicationMain.HW2Main.activeHomePage = theRole;	// Set this as the active Home																	
				
		label_UserDetails.setText("Admin: " + user.getUserName());
	...
	private ViewAdminHome() {
		...
		// GUI Area 4
		setupButtonUI(button_ManageInvitations, "Dialog", 16, 250, Pos.CENTER, 270, 200);
		button_ManageInvitations.setOnAction((event) -> 
			{ControllerAdminHome.manageInvitations(); });
	
		setupButtonUI(button_SetOnetimePassword, "Dialog", 16, 250, Pos.CENTER, 270, 250);
		button_SetOnetimePassword.setOnAction((event) -> 
			{ControllerAdminHome.setOnetimePassword(); });

		setupButtonUI(button_DeleteUser, "Dialog", 16, 250, Pos.CENTER, 270, 300);
		button_DeleteUser.setOnAction((event) -> {ControllerAdminHome.deleteUser(); });

		setupButtonUI(button_ListUsers, "Dialog", 16, 250, Pos.CENTER, 270, 350);
		button_ListUsers.setOnAction((event) -> {ControllerAdminHome.listUsers(); });

		setupButtonUI(button_AddRemoveRoles, "Dialog", 16, 250, Pos.CENTER, 270, 400);
